...
namespace ConcertBooking.WebHost.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger,
            IConcertRepo concertRepo, ITicketRepo ticketRepo, IBookingRepo bookingRepo)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vm = concerts.Where(y => y.DateTime.Date >= today).Select(x => new HomeConcertViewModel
            {
                ConcertId = x.Id,
                ConcertName = x.Name,
